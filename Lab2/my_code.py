...
# neighbours are nodes which binary index differ by one (i.e. 0110 neighbours - 0111, 0100, 0010, 1110
# See: https://www8.cs.umu.se/kurser/5DV050/VT11/lab1.pdf <- Hypercube prefix sum
